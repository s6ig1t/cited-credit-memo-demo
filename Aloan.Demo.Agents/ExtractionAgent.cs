...
using Aloan.Demo.Core;
using Anthropic;
using Microsoft.Agents.AI;
using Microsoft.Extensions.AI;

namespace Aloan.Demo.Agents;
...
/// source document. Everything downstream, ratio calculation (Aloan.Demo.Analysis) and
...
/// the public contract of this class is FinancialExtractionResult (from Aloan.Demo.Core),
