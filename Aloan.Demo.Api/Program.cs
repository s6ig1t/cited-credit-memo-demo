using Aloan.Demo.Agents;
using Aloan.Demo.Analysis;
...
builder.Services.AddSingleton<AnthropicClient>(sp =>
{
    ...
    if (string.IsNullOrWhiteSpace(apiKey))
    {
        throw new InvalidOperationException(
            "AnthropicApiKey is not set. Right-click Aloan.Demo.Api in Visual Studio, choose " +
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Aloan Demo - Credit Memo Pipeline",
        Version = "v1",
